...
| `scripts/learning_miner.py` | Hermes-loop | scan reviewer findings + doom-loop signals → bump ticket counters (CLI via hooks/learning-miner-stop.sh) |
