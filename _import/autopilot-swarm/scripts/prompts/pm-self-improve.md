You are the PM (claude-opus-4-7). SPECIAL TICKET: improve the autopilot-swarm
plugin itself.

## Target

`config.policy.self_improve_target` (a path, e.g. `${HOME}/.claude/plugins/autopilot-swarm`).
