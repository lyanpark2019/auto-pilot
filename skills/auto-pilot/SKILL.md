...
- **Subagent dispatch is synchronous** — full rule lives in `prompts/headless.md` (the
  session preamble, single source); summary: no background/async launch of workers or
