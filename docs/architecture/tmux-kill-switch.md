...
Design proposal for autopilot-swarm M4 wiring. Target files:
`/Users/lyan/.claude/plugins/autopilot-swarm/scripts/start.sh`,
`/Users/lyan/.claude/plugins/autopilot-swarm/scripts/stop.sh`,
`/Users/lyan/.claude/plugins/autopilot-swarm/agents/swarm-monitor.md`.
...
3. **swarm-monitor agent is orphaned.** `agents/swarm-monitor.md` exists
   ...
   Operator who runs `/autopilot-swarm:autopilot-swarm` gets no live
   dashboard pane.
...
Implementation ticket must pass all of these from repo root
(`/Users/lyan/.claude/plugins/autopilot-swarm`):
