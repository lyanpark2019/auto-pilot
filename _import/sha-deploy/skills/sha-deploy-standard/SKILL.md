...
|----------|------|-------|--------|---------|
| `references/python-pm2.yml` | git + PM2 | server | single | Python apps |
| `references/nextjs-pm2.yml` | git + PM2 | server | single | Next.js (build on EC2) |
| `references/nextjs-artifact.yml` | artifact + PM2 | CI | multi | Next.js (CI build + SCP) |
| `references/static-rsync.yml` | rsync | N/A | single | Static sites, SSG |
